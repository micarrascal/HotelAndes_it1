...
//        	e.printStackTrace();
	...
	public Bar adicionarBar(String nombre, String ciudad, String presupuesto, int sedes) 
	{
        ...
        try
        {
            tx.begin();
            long idBar = nextval ();
            long tuplasInsertadas = sqlHotel.adicionarHotel(pm, idBar, nombre, ciudad, presupuesto, sedes);
            tx.commit();
...
//        	e.printStackTrace();
	...
	public long eliminarBarPorNombre (String nombreBar) 
	{
        ...
        {
            tx.begin();
            long resp = sqlHotel.eliminarHotelesPorNombre(pm, nombreBar);
            tx.commit();
...
//        	e.printStackTrace();
	...
	public long eliminarBarPorId (long idBar) 
	{
        ...
        {
            tx.begin();
            long resp = sqlHotel.eliminarHotelPorId (pm, idBar);
            tx.commit();
...
//        	e.printStackTrace();
	 ...
	 * @return La lista de objetos BAR, construidos con base en las tuplas de la tabla BAR
	 */
	public List<Hotel> darBaresPorNombre (String nombreBar)
	{
		
		return sqlHotel.darHotelesPorNombre (pmf.getPersistenceManager(), nombreBar);
	}
	 ...
	 */
	public Hotel darBarPorId (long idHotel)
	{
	...
	public long aumentarSedesBaresCiudad (String ciudad)
	{
        ...
        {
            tx.begin();
            long resp = sqlHotel.aumentarSedesBaresCiudad(pm, ciudad);
            tx.commit();
